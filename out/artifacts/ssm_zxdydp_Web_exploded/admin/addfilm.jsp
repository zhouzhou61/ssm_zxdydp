...
<body>
	...
	<div id="rightSide">
		...
		<div class="line"></div>
		<div class="wrapper">
			<form action="film/addFilm.action" name="myform" method="post" onsubmit="return check()" class="form">
				<div class="widget" style="width: 80%">
					...
					<div class="formRow">
						<label>电影名称</label>
						<div class="formRight">
							<input type="text" name="filmname" class="mws-textinput" id="filmname" placeholder="请输入电影名称" />
						</div>
						<div class="clear"></div>
					</div>
					<div class="formRow">
					...
					<div class="formRow">
						<label>票价</label>
						<div class="formRight">
							<input type="text" name="price" class="mws-textinput" id="price" placeholder="请输入票价" />
						</div>
						<div class="clear"></div>
					</div>
					<div class="formRow">
					...
					<div class="formRow">
						<label>开始日期</label>
						<div class="formRight">
							<input type="text" name="thestart" class="mws-textinput" id="thestart" onclick="WdatePicker()"
								readonly="readonly" />
						</div>
						<div class="clear"></div>
					</div>
					<div class="formRow">
						<label>结束日期</label>
						<div class="formRight">
							<input type="text" name="theend" class="mws-textinput" id="theend" onclick="WdatePicker()" readonly="readonly" />
						</div>
						<div class="clear"></div>
					</div>
					<div class="formRow">
						...
						<div class="formRight">
							...
							<textarea cols="80" name="contents" id="contents" rows="10" placeholder="请输入电影介绍"> </textarea>
