...
<body>
	...
	<div class="block box">
		...
		<div id="ur_here">
			当前位置: <a href=".">首页</a>
			<code> &gt; </code>
			<a href="index/all.action">全部电影</a>
			<code> &gt; </code>
				...
				<div class="textInfo">
					<form action="index/addcart.action" method="post" name="ECS_FORMBUY" id="ECS_FORMBUY">
						...
						<ul class="ul2 clearfix">
							...
							<li class="clearfix" style="width: 100%">
								<dd>
									<strong>电影类型：</strong><a href="index/cate.action?id=${goods.cateid }">${goods.catename }</a>
								</dd>
							</li>
							<li class="clearfix" style="width: 100%">
								<dd>
									<strong>上映日期：</strong>${goods.thestart}--${goods.theend}
								</dd>
							</li>
							<li class="clearfix" style="width: 100%">
								<dd>
									...
									<table width="710" border="0" cellspacing="5" cellpadding="0">
										...
										<tr>
											...
											<td><textarea name="contents" class="inputBorder" style="height: 50px; width: 620px;"></textarea> <input
												type="hidden" name="goodsid" value="${goods.filmid }" /></td>
										</tr>
										<tr>
