			...
			<div class="widget">
				...
				<table cellpadding="0" cellspacing="0" width="100%" class="sTable">
					...
					<c:forEach items="${cityList}" var="city">
						<tr align="center">
							<td>${city.cityname}</td>
							<td><a href="city/getCityById.action?id=${city.cityid}">编辑</a>&nbsp;&nbsp;<a
								href="city/deleteCity.action?id=${city.cityid}" onclick="{if(confirm('确定要删除吗?')){return true;}return false;}">删除</a></td>
						</tr>
					</c:forEach>
				</table>
