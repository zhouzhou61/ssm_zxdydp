...
<body>
	...
	<div id="rightSide">
		...
		<div class="line"></div>
		<div class="wrapper">
			<form action="city/addCity.action" name="myform" method="post" onsubmit="return check()" class="form">
				<div class="widget" style="width: 40%">
					...
					<div class="formRow">
						<label>城市名称</label>
						<div class="formRight">
							<input type="text" name="cityname" class="mws-textinput" id="cityname" placeholder="请输入城市名称" />
						</div>
						<div class="clear"></div>
					</div>
