...
<body>
	...
	<div id="rightSide">
		...
		<div class="line"></div>
		<div class="wrapper">
			<form action="cinema/addCinema.action" name="myform" method="post" onsubmit="return check()" class="form">
				<div class="widget" style="width: 40%">
					...
					<div class="formRow">
						<label>影院名称</label>
						<div class="formRight">
							<input type="text" name="cinemaname" class="mws-textinput" id="cinemaname" placeholder="请输入影院名称" />
						</div>
						<div class="clear"></div>
					</div>
					<div class="formRow">
